...
type ShareResponse struct {
	...
	ExpiredAt      *time.Time `json:"expired_at"`
	FullShareURL   string     `json:"full_share_url,omitempty"`   // 完整分享页链接
	DownloadURL    string     `json:"download_url,omitempty"`     // 完整下载地址
	ResponseType   string     `json:"response_type,omitempty"`    // code | url
	DisplayValue   string     `json:"display_value,omitempty"`    // 按配置应展示/复制的值
