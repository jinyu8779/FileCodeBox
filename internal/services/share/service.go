...
// UploadConfig 暴露上传配置给 handler
func (s *Service) UploadConfig() *config.UploadConfig {
	if s == nil || s.manager == nil || s.manager.Transfer == nil {
		return nil
	}
	return s.manager.Transfer.Upload
}
